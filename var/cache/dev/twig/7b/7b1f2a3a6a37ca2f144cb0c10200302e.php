...
class __TwigTemplate_1c7af93d0c9b5c4caadbc8f0b8ae673a extends Template
{
...
";
    ...
    <div>
        ";
        // line 17
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 17, $this->source); })()), "text", [], "any", false, false, false, 17), 'label', ["label_attr" => ["class" => "block text-sm text-gray-700 dark:text-gray-300 font-medium"], "label" => "Please enter the comment!"]);
        yield "
        ";
        // line 18
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 18, $this->source); })()), "text", [], "any", false, false, false, 18), 'widget', ["attr" => ["class" => "block w-full shadow-sm border-gray-300 dark:border-transparent dark:bg-white dark:text-gray-800 rounded-md border p-2 mt-1 mb-2"]]);
        yield "
        ";
        // line 19
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 19, $this->source); })()), "text", [], "any", false, false, false, 19), 'errors');
        yield "
    </div>


    <div>
        <button type=\"submit\" class=\"block w-full shadow-sm border-transparent bg-indigo-600 bg-indigo-700 dark:bg-indigo-500 dark:hover:bg-indigo-400 text-white rounded-md border p-2 mt-4 mb-2\"> Add Comment!</button>
    </div>
...
";
    ...
    {
        return array (  163 => 27,  152 => 19,  148 => 18,  144 => 17,  138 => 14,  134 => 13,  128 => 10,  115 => 9,  101 => 6,  88 => 5,  65 => 3,  42 => 1,);
    }
...
{% endblock %}
", "micro_post/comment.html.twig", "/Users/nadia/Desktop/Symfony/test/symfony-handson/templates/micro_post/comment.html.twig");
    }
}
